...
/* Brand / UI icons for the destinations, centralized so the .ts destination
   files can stay logic-only. All are monochrome and use currentColor, so they
   follow the menu text color (and stay legible in dark mode).
   Brand marks (X, OpenAI/ChatGPT, Claude, Gemini, GitHub) are the official
   single-color logos, used functionally to link to each service. */

const solid = (path: string, viewBox = '0 0 24 24'): ReactNode => (
  <svg viewBox={viewBox} width="1em" height="1em" fill="currentColor" aria-hidden="true">
    <path d={path} />
  </svg>
)

export const XIcon = solid(
...
export const ChatGPTIcon = solid(
...
export const GeminiIcon = solid(
  'M11.04 19.32Q12 21.51 12 24q0-2.49.93-4.68.96-2.19 2.58-3.81t3.81-2.55Q21.51 12 24 12q-2.49 0-4.68-.93a12.3 12.3 0 0 1-3.81-2.58 12.3 12.3 0 0 1-2.58-3.81Q12 2.49 12 0q0 2.49-.96 4.68-.93 2.19-2.55 3.81a12.3 12.3 0 0 1-3.81 2.58Q2.49 12 0 12q2.49 0 4.68.96 2.19.93 3.81 2.55t2.55 3.81',
)

export const RedditIcon = solid(
...
/* Hacker News uses the Y Combinator mark (no separate HN logo in Simple Icons). */
export const HackerNewsIcon = solid(
...
/* Non-brand line icons (no official logo applies). */
export const MailIcon: ReactNode = (
  <svg
    viewBox="0 0 24 24"
    width="1em"
    height="1em"
...
export const GearIcon: ReactNode = (
  <svg
    viewBox="0 0 24 24"
    width="1em"
    height="1em"
...
/* GitHub Gist has no distinct official mark — use a code-snippet glyph. */
export const GistIcon: ReactNode = (
  <svg
    viewBox="0 0 24 24"
    width="1em"
    height="1em"
...
/* Tools menu (top-left) — three dots. */
...
/* Feedback — an outlined speech bubble, to match the line-style icons. */
export const FeedbackIcon: ReactNode = (
  <svg
    viewBox="0 0 24 24"
    width="1em"
    height="1em"
...
export const CloudIcon = solid(
  'M6,19A5,5 0 0,1 1,14A5,5 0 0,1 6,9C7,6.65 9.3,5 12,5C15.43,5 18.24,7.66 18.5,11.03L19,11A4,4 0 0,1 23,15A4,4 0 0,1 19,19H6Z',
)

export const BucketIcon = solid(
